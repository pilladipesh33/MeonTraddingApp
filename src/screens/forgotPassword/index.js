...
const ForgotPassword = ({navigation}) => {
  ...
  useEffect(()=> {
    if(payload){
        dispatch(forgotPasswordItem(payload))
    }
  },[payload])

  useEffect(()=>{
    if(forgotPasswordDetails?.type == 'success'){
        // console.log('forgotPasswordDetails', forgotPasswordDetails)
        alert(`${forgotPasswordDetails?.description}`)
        navigation.navigate('Login', {key: 'forgotPassword'})
    }
